...
Vanaf versie 1.3.0 kun je Hipsy Events ook gebruiken zonder Elementor. Dit werkt o.a. in Salient/WPBakery via een Shortcode/Text element.

Voorbeelden:
[hipsy_events_grid limit="6" columns="3"]
[hipsy_events_list limit="10"]
[hipsy_events_agenda limit="20"]
[hipsy_events_calendar limit="20"]
[hipsy_events_month]

Optionele attributen:
limit="6"              Aantal events
future="yes"           Alleen toekomstige events
category="slug"         Filter op event_categorie
columns="3"             Alleen bij grid, 1 t/m 4 kolommen
image="yes"             Afbeelding tonen/verbergen
description="yes"       Beschrijving tonen/verbergen
price="yes"             Prijs tonen/verbergen
button_text="Tickets"   Tekst van ticketknop
info_text="Meer info"   Tekst van infoknop
